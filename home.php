                ...
                <div class="fullwidthbanner" id="intro">
                    <ul>
                        ...
                        <li data-transition="random" data-slotamount="10" data-masterspeed="300">
                            ...
                            <div class="caption big_white lfb stt" data-x="center" data-y="350" data-speed="500" data-start="1800" data-easing="<?php echo HOST . FOLDER ?>easeOutExpo" data-end="7100" data-endspeed="300" data-endeasing="easeInSine">
                        ...
                        <ul class="filter-container clearfix">
                            ...
                            <li class="class<?php echo $i+1 ?>">
                                ...
                                <div class="arr-content">
                                    <a href="<?php echo HOST.FOLDER."single/".$item['iditem']?>">
